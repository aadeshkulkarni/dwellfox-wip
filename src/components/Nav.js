    ...
    return (
        <>
            {isOpen ? <nav className="fixed top-0 left-0 z-50 flex flex-col items-center justify-center w-full h-screen overflow-hidden text-white bg-gray-900 sm:block lg:hidden">
                <div className="absolute text-4xl top-4 right-6 font-extralight" onClick={menuClicked}>X</div>
                <h1 className="p-4 m-4 text-3xl font-bold uppercase">Dwellfox</h1>
                <ul className="w-4/5">
                    <li className="block p-4 m-4 tracking-widest text-center uppercase border-b border-gray-800"><Link to="" onClick={menuClicked}>Home</Link></li>
                    <li className="block p-4 m-4 tracking-widest text-center uppercase border-b border-gray-800"><Link to="about" onClick={menuClicked}>About</Link></li>
                    <li className="block p-4 m-4 tracking-widest text-center uppercase border-b border-gray-800"><Link to="service" onClick={menuClicked}>Service</Link></li>
                    <li className="block p-4 m-4 tracking-widest text-center uppercase border-b border-gray-800"><Link to="career" onClick={menuClicked}>Career</Link></li>
                    <li className="block p-4 m-4 tracking-widest text-center uppercase border-b border-gray-800"><Link to="contact" onClick={menuClicked}>Contact</Link></li>
                </ul>
            </nav> :
                <nav className="fixed top-0 left-0 z-10 flex items-center w-full text-white bg-gray-900 sm:block lg:hidden backdrop-opacity-90">
