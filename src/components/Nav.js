    ...
    return (
        <>
            {isOpen ? <nav className="fixed top-0 left-0 z-50 flex flex-col items-center justify-center w-full h-screen overflow-hidden text-white bg-gray-900 sm:block lg:hidden">
                ...
                <h1 className="p-4 m-4 text-3xl font-bold uppercase" onClick={()=>{window.location.reload()}}>Dwellfox</h1>
                <ul className="w-4/5">
                ...
                <nav className="fixed top-0 left-0 z-10 flex items-center w-full px-4 text-white bg-gray-900 sm:block lg:hidden backdrop-opacity-90">
                    <div className="inline-block w-2/4 p-4 text-xl tracking-widest uppercase" onClick={()=>{window.location.reload()}}>Dwellfox</div>
            ...
            <nav className="fixed top-0 left-0 z-10 hidden w-full text-white bg-opacity-10 sm:block">
                <div className="flex items-center ">
                    <div className="inline-block w-2/4 p-4 pl-8 text-3xl font-bold tracking-widest uppercase" onClick={()=>{window.location.reload()}}>Dwellfox</div>
